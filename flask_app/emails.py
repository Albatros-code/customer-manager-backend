...
def send_verification_email(receiver_email, email_verification_string):
    ...
    <body>
        ...
        <a href="{os.environ.get('FRONTEND_HOST_2')}/register/{email_verification_string}"><button>Confirm</button></a>
        </p>
    </body>
    </html>
    """
...
def send_reset_password_email(receiver_email: str, reset_password_string: str):
    ...
    {os.environ.get('FRONTEND_HOST_2')}/reset-password?token={reset_password_string}
    """
    html = f"""\
    <html>
    <body>
        ...
        <p><a href="{os.environ.get('FRONTEND_HOST_2')}/reset-password?token={reset_password_string}"><button>Reset password</button></a></p>
